...
pub enum Opcode {
    ...
    AddReg, // N: blank[3]-setflags[1]-rn[4]-rm[4]-rd[4] / W: blank[3]-setflags[1]-rm[4]-rn[4]-rd[4] + blank[23]-shift_n[5]-shift_t[2]
    ...
    AndReg, // N: blank[10]-rm[3]-rdn[3] / W: blank[3]-setflags[1]-rm[4]-rn[4]-rd[4] + blank[23]-shift_n[5]-shift_t[2]
    AsrImm, // N: blank[5]-shift[5]-rm[3]-rd[3] / W: blank[11]-setflags[1]-rm[4]-rd[4] + blank[25]-shift_n[5]
    ...
    BicReg, // N: blank[10]-rm[3]-rdn[3] / W: blank[3]-setflags[1]-rm[4]-rn[4]-rd[4] + blank[23]-shift_n[5]-shift_t[2]
    ...
    CmnReg, // N: blank[12]-rm[3]-rn[3] / W: blank[8]-rm[4]-rn[4] + blank[23]-shift_n[5]-shift_t[2]
    CmpImm, // N: blank[5]-rn[3]-imm8[8] / W: blank[8]-rn[4]-spill[4] + modified[30]
    CmpReg, // N: blank[10]-rm[4]-rn[4] / W: blank[8]-rm[4]-rn[4] + blank[23]-shift_n[5]-shift_t[2]
    Cps,    // N: blank[13]-nonzero[1]-I[1]-F[1]
    EorImm, // W: blank[3]-setflags[1]-rn[4]-rd[4]-spill[4] + modified[30]
    EorReg, // N: blank[10]-rm[3]-rdn[3] / W: blank[3]-setflags[1]-rm[4]-rn[4]-rd[4] + blank[23]-shift_n[5]-shift_t[2]
